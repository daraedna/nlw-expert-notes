...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
    ...
    <Dialog.Root>
        <Dialog.Trigger className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
            <span className='text-small fonte-medium text-slate-200'>
            ...
            <div className='absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-slate-800 to-slate-800/20 pointer-events-none'/>
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className='fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
                ...
                <button
                    ...
                    className='2-full bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font-medium group'
                >
